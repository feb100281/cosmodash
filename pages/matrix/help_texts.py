...
MATRIX_ZONES_HELP_MD = """
#### Как читать матрицу ABC-XYZ

| Категория | Значение |
|---------|----------------|
| AX | Главные товары — всегда должны быть в наличии |
| AY | Хорошо продаются, но нестабильно — нужен запас |
| AZ | Много денег, но скачки спроса — риск дефицита |
| BX | Средние, но продаются ровно — можно планировать |
| BY | Обычные товары — стандартная закупка |
| BZ | Продаются рывками — закупать осторожно |
| CX | Мало продаж, но стабильно — держать минимум |
| CY | Второстепенные товары — по необходимости |
| CZ | Плохо продаются — кандидаты на вывод из ассортимента |
"""
